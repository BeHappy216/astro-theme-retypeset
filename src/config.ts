...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    title: '如犀独行',
    // site subtitle
    subtitle: '遵循古老教法的现代修行',
    // site description
    description: '原始佛法经典，解脱道禅修',
    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: true, // true, false
    // author name
    author: '张欢喜',
    // site url
    url: 'https://blog.deva.im',
    // base path
  ...
  color: {
    ...
    light: {
      ...
      highlight: 'oklch(0.5259 0.2334 270.39 / 0.5)', // rgba(62,81,238,0.5)
    },
    dark: {
      // primary color
  ...
  global: {
    // default language
    locale: 'zh', // 'zh', 'en', 'zh-tw'
    // more languages
    // not fill in the locale code above again, can be an empty array []
    moreLocales: ['en', 'zh-tw'], // e.g. ['en', 'zh-tw']
  ...
  comment: {
    ...
    waline: {
      // server url
      serverURL: 'https://waline.987988.xyz',
      // emoji url
      emoji: [
